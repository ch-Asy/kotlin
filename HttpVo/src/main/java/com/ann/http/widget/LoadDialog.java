...
public class LoadDialog extends Dialog {
    ...
    private TextView show_msg_view;
    ...
    public LoadDialog(final Context ctx, boolean canNotCancel, String tipMsg) {
        ...
        show_msg_view = (TextView) findViewById(R.id.show_message);
        if (!TextUtils.isEmpty(this.tipMsg)) {
            show_msg_view.setVisibility(View.VISIBLE);
            if (this.tipMsg.length() > 5) {
                show_msg_view.setTextSize(12);
            }
            show_msg_view.setText(this.tipMsg);
        } else {
            show_msg_view.setVisibility(View.GONE);
        }
        setCancelable(canNotCancel);
