...
public class NPermission {
    ...
    public static NPermission create(Context context) {
        return new NPermission(context);
    }

    public NPermission(Context context) {
        mContext = context;
        mNormalPermissionNames = mContext.getResources().getStringArray(R.array.permissionNames);
    }

    public NPermission title(String title) {
        mTitle = title;
        return this;
    }

    public NPermission msg(String msg) {
        mMsg = msg;
        return this;
    }

    public NPermission permissions(List<PermissionItem> permissionItems) {
        mCheckPermissions = permissionItems;
        return this;
    }

    public NPermission filterColor(int color) {
        mFilterColor = color;
        return this;
    }

    public NPermission animStyle(int styleId) {
        mAnimStyleId = styleId;
        return this;
    }

    public NPermission style(int styleResIdsId) {
